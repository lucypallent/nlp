...
model = AutoModelForMaskedLM.from_pretrained('dbert_models/dbert-final')
model.eval()

tokenizer = AutoTokenizer.from_pretrained('dbert_models/dbert-final')


# mem issues, will run with cpu seperately
